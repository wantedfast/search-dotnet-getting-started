...
namespace AzureSearch.SDKHowTo
{
    class Program
    {
        ...
        private static SearchIndexClient CreateSearchIndexClient(IConfigurationRoot configuration)
        {
            ...
            SearchIndexClient indexClient = new SearchIndexClient(new Uri(searchServiceName), new AzureKeyCredential(adminApiKey));
            return indexClient;
        }
        ...
        private static SearchClient CreateSearchClient(IConfigurationRoot configuration)
        {
            ...
            SearchClient searchClient = new SearchClient(new Uri(searchServiceName), "hotels", new AzureKeyCredential(queryApiKey));
            return searchClient;
        }
